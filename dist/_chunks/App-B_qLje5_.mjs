...
import { p as pluginPermissions, P as PLUGIN_ID } from "./index-C2ks_0_1.mjs";
...
var Options = function Options2(props) {
  ...
  var _React$useState = React__default.useState(""), _React$useState2 = _slicedToArray(_React$useState, 2), goInputText = _React$useState2[0], setGoInputText = _React$useState2[1];
...
var Pager = function Pager2(props) {
  ...
  var pager = itemRender(page, "page", /* @__PURE__ */ React__default.createElement("a", {
    rel: "nofollow"
  }, page));
...
var Pagination = function Pagination2(props) {
  ...
  var _React$useState = React__default.useState(current), _React$useState2 = _slicedToArray(_React$useState, 2), internalInputVal = _React$useState2[0], setInternalInputVal = _React$useState2[1];
  useEffect(function() {
  ...
  if (simple) {
    ...
    simplePager = /* @__PURE__ */ React__default.createElement("li", {
  ...
  if (allPages <= 3 + pageBufferSize * 2) {
    ...
    if (showPrevNextJumpers) {
      jumpPrev = jumpPrevContent ? /* @__PURE__ */ React__default.createElement("li", {
      ...
      jumpNext = jumpNextContent ? /* @__PURE__ */ React__default.createElement("li", {
    ...
    if (left !== 1) {
      pagerList.unshift(/* @__PURE__ */ React__default.createElement(Pager, _extends({}, pagerProps, {
        key: 1,
        page: 1
      })));
    }
...
(function(module, exports) {
  (function(root, undefined$12) {
    ...
    {
      if (module.exports) {
        exports = module.exports = lib2;
      }
      exports.accounting = lib2;
    }
  })();
