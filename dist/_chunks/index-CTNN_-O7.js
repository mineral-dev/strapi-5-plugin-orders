...
const PluginIcon = () => /* @__PURE__ */ jsxRuntime.jsx(icons.Store, {});
...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await Promise.resolve().then(() => require("./App-DD7GbW2U.js"));
        return App;
      },
...
//# sourceMappingURL=index-CTNN_-O7.js.map
